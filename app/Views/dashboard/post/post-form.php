    ...
    <section>
      ...
      @submit.prevent="saveData">
        ...
        <div class="row">
          ...
          <div class="col-md-3">
            <card title="Setup">
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  <combobox v-model="form.categoryId" 
                  field="title"
                  invalid-field="categoryId" 
                  placeholder="Category"
                  :data-source="rsCategory" 
        ...
        <floatarea>
          <button_ color="info" 
          icon="arrow-left"  
          :to="baseURL('dashboard/post')"></button_>
  ...
  <script>
    new Vue({ 
      ...
      data: {
        ...
        editSlug: false,
        response: {},
        rsCategory: <?= json_encode($rsCategory) ?>,
        publicationRecords: [
          'Published',
          'Draft',
        ],
      ...
      methods: {
        ...
        async saveData(event) {
          const url = baseURL(
            'dashboard/post/' + this.mode + ((this.mode == 'update')?'?id=' + this.form.id:'')
          );
